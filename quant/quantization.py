## this is the code from ist daslab. License belongs to them.
### Modify this to support your code
''' The Quantizer class and Quant3Linear module are used for quantizing neural network weights and activations to reduce
memory usage and improve inference speed. The Quantizer class finds the optimal scaling and zero-point values for
quantization, while the Quant3Linear module performs quantized matrix multiplication using 3-bit integers. '''
